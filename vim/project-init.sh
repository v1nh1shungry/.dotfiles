...
if [ "$BUILD_SYSTEM" = "cmake" ]; then
  ...
  sed -i "s/AsynctaskProjectInitProjectName/$PROJECT_NAME/g" "$PROJECT_NAME/CMakeLists.txt"
  ...
  sed -i "s/AsynctaskProjectInitProjectName/$PROJECT_NAME/g" "$PROJECT_NAME/xmake.lua"
